    ...
    $(function() {
        ...
        var Router = Backbone.Router.extend({
            ...
            'dashboard': function() {
                ...
                const search_by_username = document.getElementById('search_by_username');
                const emailVc = localStorage.getItem('AcountEmailReceiver');
                search_by_username.value = emailVc;
                searching(emailVc)
